...
WITH target_tables AS (
    SELECT 'AWARD_DISTRIBUTION_D' AS tname FROM dual UNION ALL
    SELECT 'BRKR_PLAN_CUSTODY_ACCT_D' FROM dual UNION ALL
    SELECT 'BRKR_PRTC_D' FROM dual UNION ALL
    SELECT 'CLNT_DOC_CALLOUTS_D' FROM dual UNION ALL
    SELECT 'CLNT_DOC_PRODUCTS_D' FROM dual UNION ALL
    SELECT 'CORP_ACTION_D' FROM dual UNION ALL
    SELECT 'CORP_GRANT_TAX_D' FROM dual UNION ALL
    SELECT 'CUSIP_PRICING_ADJ_D' FROM dual UNION ALL
    SELECT 'DATE_D' FROM dual UNION ALL
    SELECT 'DISTRIBUTION_FRQ_D' FROM dual UNION ALL
    SELECT 'DISTRIBUTION_SCHD_D' FROM dual UNION ALL
    SELECT 'ENDING_BALANCE_F' FROM dual UNION ALL
    SELECT 'ENDING_BALANCE_IFRS_F' FROM dual UNION ALL
    SELECT 'FED_INTEREST_RTE_D' FROM dual UNION ALL
    SELECT 'FILE_LOAD_INFO_D' FROM dual UNION ALL
    SELECT 'FISCAL_MONTH_D' FROM dual UNION ALL
    SELECT 'GRANT_ACTIVITY_TRX_F' FROM dual UNION ALL
    SELECT 'GRANT_AGREE_D' FROM dual UNION ALL
    SELECT 'GRANT_EXPENSE_F' FROM dual UNION ALL
    SELECT 'GRANT_EXPENSE_F_ARC' FROM dual UNION ALL
    SELECT 'GRANT_TRANCHE_D' FROM dual UNION ALL
    SELECT 'GRANT_TRANCHE_EXT_D' FROM dual UNION ALL
    SELECT 'GRANT_VAL_ASSUMPTION_D' FROM dual UNION ALL
    SELECT 'GRK_TERM_SCHEDULE_D' FROM dual UNION ALL
    SELECT 'OFFERING_D' FROM dual UNION ALL
    SELECT 'OVERRIDE_D' FROM dual UNION ALL
    SELECT 'PARTICIPANT_D' FROM dual UNION ALL
    SELECT 'PARTICIPANT_GPID_D' FROM dual UNION ALL
    SELECT 'PERFORMANCE_SCHD_D' FROM dual UNION ALL
    SELECT 'PERF_GRANT_RATE_D' FROM dual UNION ALL
    SELECT 'PERF_PERIOD_GRANT_D' FROM dual UNION ALL
    SELECT 'PERF_PERIOD_VESTING_D' FROM dual UNION ALL
    SELECT 'PLAN_D' FROM dual UNION ALL
    SELECT 'PLAN_SPONSOR_D' FROM dual UNION ALL
    SELECT 'PRODUCT_MAPPINGS_D' FROM dual UNION ALL
    SELECT 'PROD_D' FROM dual UNION ALL
    SELECT 'PRORATION_RL_D' FROM dual UNION ALL
    SELECT 'PRTC_EMAIL_GPID_D' FROM dual UNION ALL
    SELECT 'PRTC_GRANT_CSTM_D' FROM dual UNION ALL
    SELECT 'PRTC_GRANT_D' FROM dual UNION ALL
    SELECT 'PRTC_GRANT_D_MV' FROM dual UNION ALL
    SELECT 'PRTC_GRANT_D_PLAN_MV' FROM dual UNION ALL
    SELECT 'PRTC_GRANT_EXT_D' FROM dual UNION ALL
    SELECT 'PRTC_IDENTIFIERS_D' FROM dual UNION ALL
    SELECT 'PRTC_MOBILITY_D' FROM dual UNION ALL
    SELECT 'PRTC_PHONE_GPID_D' FROM dual UNION ALL
    SELECT 'PRTC_TAX_F' FROM dual UNION ALL
    SELECT 'PS_FAS_LEDGER_D' FROM dual UNION ALL
    SELECT 'RPT_DIST_TRX_CTA_F' FROM dual UNION ALL
    SELECT 'TERMINATION_SCHD_D' FROM dual UNION ALL
    SELECT 'TRANCHE_EXPENSE_F' FROM dual UNION ALL
    SELECT 'TRANCHE_EXPENSE_F_ARC' FROM dual UNION ALL
    SELECT 'TRANCHE_VAL_ASSUMPTION_D' FROM dual UNION ALL
    SELECT 'T_FSBFF_BLACKOUT_RULE_FILTER_F' FROM dual UNION ALL
    SELECT 'T_FSBGF_BLACKOUT_GRANT_F' FROM dual UNION ALL
    SELECT 'T_FSBGF_BLACKOUT_GRANT_HIST' FROM dual UNION ALL
    SELECT 'T_FSBGF_BLACKOUT_GRANT_STG' FROM dual UNION ALL
    SELECT 'T_FSBPD_TAX_BKT_RNG_D' FROM dual UNION ALL
    SELECT 'T_FSBRD_BLACKOUT_RL_D' FROM dual UNION ALL
    SELECT 'T_FSDID_DIVIDEND_D' FROM dual UNION ALL
    SELECT 'T_FSGVD_GRNT_VEST_DIV_F' FROM dual UNION ALL
    SELECT 'T_FSLRD_LOT_LVL_RSTC_D' FROM dual UNION ALL
    SELECT 'T_FSLVF_TAX_ALLOC_F' FROM dual UNION ALL
    SELECT 'T_FSOCF_ORD_CANCEL_F' FROM dual UNION ALL
    SELECT 'T_FSPRG_PRTC_G_TAX_F' FROM dual UNION ALL
    SELECT 'T_FSPRG_PRTC_G_TAX_F_ND' FROM dual UNION ALL
    SELECT 'T_FSPTA_PRTC_TAX_ASGN_DTL_F' FROM dual UNION ALL
    SELECT 'T_FSPTB_PRTC_TAX_ASGN_DTL_FS' FROM dual UNION ALL
    SELECT 'T_FSSED_SEC_D' FROM dual UNION ALL
    SELECT 'T_FSTMF_TAX_METH_F' FROM dual UNION ALL
    SELECT 'T_FSTMF_TAX_METH_F_UTC' FROM dual UNION ALL
    SELECT 'T_FSTPD_TAX_ASGT_D' FROM dual UNION ALL
    SELECT 'VESTING_ACTIVITY_TRX_F' FROM dual
)
SELECT t.tname AS TABLE_NAME,
       CASE WHEN c.column_name IS NOT NULL THEN 'HAS COLUMN' ELSE 'MISSING COLUMN' END AS STATUS
FROM target_tables t
LEFT JOIN dba_tab_columns c
  ON t.tname = c.table_name
 AND c.owner = 'SPR00DBO'
 AND c.column_name = 'BEGIN_VERSION_DATE'
...
WITH target_tables AS (
    SELECT 'GRK_AWARD_DISTRIBUTION_D' AS tname FROM dual UNION ALL
    SELECT 'GRK_BRKR_PLAN_CUSTODY_ACCT_D' FROM dual UNION ALL
    SELECT 'GRK_CSR_HIER_SETUP_D' FROM dual UNION ALL
    SELECT 'GRK_DIST_PAID_TRNF_REQ_D' FROM dual UNION ALL
    SELECT 'GRK_DIST_PAID_TRNS_DTL_D' FROM dual UNION ALL
    SELECT 'GRK_EST_TAX_D' FROM dual UNION ALL
    SELECT 'GRK_FILE_LOAD_INFO_D' FROM dual UNION ALL
    SELECT 'GRK_GRANT_AGREE_D' FROM dual UNION ALL
    SELECT 'GRK_GRANT_TRANCHE_D' FROM dual UNION ALL
    SELECT 'GRK_GRNT_VEST_DIV_F' FROM dual UNION ALL
    SELECT 'GRK_PERF_GRANT_PED_D' FROM dual UNION ALL
    SELECT 'GRK_PRTC_GRANT_D' FROM dual UNION ALL
    SELECT 'GRK_RETIREMENT_ELG_RULE_D' FROM dual UNION ALL
    SELECT 'GRK_SHRPOOL_GRANT_F' FROM dual UNION ALL
    SELECT 'GRK_SHRPOOL_SUMMARY_FS' FROM dual UNION ALL
    SELECT 'GRK_STOCK_PRICE_D' FROM dual UNION ALL
    SELECT 'GRK_VEST_PED_SUMMARY_F' FROM dual
)
SELECT t.tname AS TABLE_NAME,
       CASE WHEN c.column_name IS NOT NULL THEN 'HAS COLUMN' ELSE 'MISSING COLUMN' END AS STATUS
FROM target_tables t
