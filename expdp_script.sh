...
[/vldcdsta20rtp2/backup/SPSSG1/sim_dump]
oracle@vl1118428rtp2:SPSSG11> df -kh
...
/dev/mapper/appsvg_vl1118428rtp2-lv_vldcdsta20rtp2_oracle          6.0G  293M  5.8G   5% /vldcdsta20rtp2/oracle
...
/dev/mapper/appsvg_vl1118428rtp2-lv_support_tools_oracle            25G  1.9G   24G   8% /support_tools/oracle
/dev/mapper/appsvg_vl1118428rtp2-lv_home_oracle                    8.0G  185M  7.9G   3% /home/oracle
...
/dev/asm/volume1-478                                               2.0T  1.9T  137G  94% /vldcdsta20rtp2/backup
...
/dev/mapper/appsvg_vl1118428rtp2-lv_vldcdsta20rtp2_oracle_dba       25G  211M   25G   1% /vldcdsta20rtp2/oracle/dba
/dev/mapper/appsvg_vl1118428rtp2-lv_vldcdsta20rtp2_oracle_product   60G   13G   48G  21% /vldcdsta20rtp2/oracle/product
/dev/mapper/appsvg_vl1118428rtp2-lv_support_tools_oracle            25G  1.8G   24G   8% /support_tools/oracle
/dev/mapper/appsvg_vl1118428rtp2-lv_home_oracle                    8.0G  185M  7.9G   3% /home/oracle
tmpfs                                                               13G     0   13G   0% /run/user/103
/dev/mapper/appsvg_vl1118428rtp2-lv_home_oemagent                  6.0G  1.8G  4.3G  29% /home/oemagent
tmpfs                                                               13G     0   13G   0% /run/user/142264
/dev/asm/volume1-478                                               2.0T  2.0T     0 100% /vldcdsta20rtp2/backup
...
DIRECTORY=sim_dump
DUMPFILE=spr_7tab_%U.dmp
LOGFILE=spr_7tab.log
TABLES=SPR00DBO.GRANT_TRANCHE_EXT_D,SPR00DBO.GRANT_VAL_ASSUMPTION_D,SPR00DBO.OFFERING_D,SPR00DBO.PRODUCT_MAPPINGS_D,SPR00DBO.PRTC_GRANT_EXT_D,SPR00DBO.TRANCHE_VAL_ASSUMPTION_D,SPR00DBO.VESTING_ACTIVITY_TRX_F
QUERY="WHERE BEGIN_VERSION_DATE >= ADD_MONTHS(TRUNC(SYSDATE,'MM'), -24)"
COMPRESSION=ALL
PARALLEL=32

chmod +x spr_7tab.par

nohup expdp parfile=spr_7tab.par & 
